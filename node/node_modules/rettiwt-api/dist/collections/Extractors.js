...
exports.extractors = {
    ...
    TWEET_LIKERS: (response) => new CursoredData_1.CursoredData(response, Data_1.EBaseType.USER),
    ...
    USER_AFFILIATES: (response) => new CursoredData_1.CursoredData(response, Data_1.EBaseType.USER),
